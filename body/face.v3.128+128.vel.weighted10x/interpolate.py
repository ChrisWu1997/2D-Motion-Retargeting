...
if __name__ == '__main__':
    ...
    if args.write_json is not None:
        ...
        out12_dir = os.path.join(args.write_json, 'point-motion1char2')
        out21_dir = os.path.join(args.write_json, 'point-motion2char1')
        ensure_dir(out1_dir)
        ensure_dir(out2_dir)
    ...
    for i in tqdm(range(vlen)):
        ...
        cv2.putText(img_out12, 'motion1+char2', (20, 20), 1, 2, (0, 0, 255), 1)
        cv2.putText(img_out21, 'motion2+char1', (20, 20), 1, 2, (0, 0, 255), 1)
