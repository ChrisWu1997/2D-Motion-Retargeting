...
if __name__ == '__main__':
    ...
    if args.save_dir is not None or args.write_json is not None:
        ...
        ensure_dir(save_dir)
        motion2video(input1, h1, w1, os.path.join(save_dir, 'input1.mp4'), args.color1, args.transparency, fps=args.fps1)
        motion2video(input2, h2, w2, os.path.join(save_dir, 'input2.mp4'), args.color2, args.transparency, fps=args.fps2)
        motion2video(out12, h2, w2, os.path.join(save_dir, 'output12.mp4'), args.color2, args.transparency, fps=args.fps1)
        motion2video(out21, h1, w1, os.path.join(save_dir, 'output21.mp4'), args.color1, args.transparency, fps=args.fps2)
