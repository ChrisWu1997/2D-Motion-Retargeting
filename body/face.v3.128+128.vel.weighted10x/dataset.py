...
TRAIN_CHARACTERS = ['Aj', 'BigVegas', 'Claire', 'Jasper', 'Lola', 'Malcolm', 'Pearl', 'Warrok', 'Globin', 'Kaya', 'PeanutMan']
VALIDATION_CHARACTERS = ['Ty', 'Andromeda', 'Pumpkinhulk', 'SportyGranny', 'Whiteclown']
MEAN_POSE_PATH = os.path.join('./model/meanpose_11char_gtvGOP-noroot-face-mid.npy')
STD_POSE_PATH = os.path.join('./model/stdpose_11char_gtvGOP-noroot-face-mid.npy')
