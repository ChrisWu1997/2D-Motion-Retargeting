...
DATA_ROOT = '/data1/wurundi/mixamo/mixamo-3d-data-withface'
TRAIN_CHARACTERS = ['Aj', 'BigVegas', 'Claire', 'Jasper', 'Lola', 'Pearl', 'Warrok', 'Globin', 'Kaya', 'PeanutMan']
VALIDATION_CHARACTERS = ['Ty', 'Pumpkinhulk', 'SportyGranny', 'Whiteclown']
VIEW_RANGES = [(0, 0, -np.pi / 2),
               ...
               (0, 0, np.pi / 3),
               (0, 0, np.pi / 2)]
MEAN_POSE_PATH = os.path.join('./model/meanpose_whole_7view-LPP-noroot-gt-10.npy')
STD_POSE_PATH = os.path.join('./model/stdpose_whole_7view-LPP-noroot-gt-10.npy')
#MEAN_POSE_PATH = os.path.join(DATA_ROOT, 'meanpose_whole_7view-LPP-noroot-gt-10.npy')
#STD_POSE_PATH = os.path.join(DATA_ROOT, 'stdpose_whole_7view-LPP-noroot-gt-10.npy')
FAILED_MOTIONS_PATH = os.path.join(DATA_ROOT, 'face_7view_failed.npy')
'''
FAILED_MOTIONS = ['Breakdance-1990-1/motions/1.npy', 'Breakdance-Ending-1/motions/3.npy',
 'Cartwheel/motions/1.npy', 'Dancing-3/motions/1.npy',
 'Defender-1/motions/1.npy', 'Defender-1/motions/2.npy',
 'Defender/motions/1.npy', 'Defender/motions/2.npy',
 'Double-Leg-Takedown---Attacker-1/motions/1.npy',
 'Double-Leg-Takedown---Attacker-1/motions/2.npy',
 'Goalkeeper-Catch-3/motions/1.npy', 'Goalkeeper-Directing-1/motions/1.npy',
 'Goalkeeper-Directing-1/motions/2.npy',
 'Goalkeeper-Directing/motions/2.npy', 'Goalkeeper-Directing/motions/5.npy',
 'Goalkeeper-Diving-Save-1/motions/1.npy',
 'Goalkeeper-Diving-Save/motions/1.npy',
 'Goalkeeper-Drop-Kick/motions/2.npy',
 'Goalkeeper-Overhand-Throw/motions/1.npy',
 'Goalkeeper-Placing-Ball-1/motions/5.npy',
 'Goalkeeper-Placing-Ball-1/motions/6.npy', 'Goalkeeper-Scoop/motions/1.npy',
 'Quick-Steps/motions/2.npy', 'Quick-Steps/motions/5.npy',
 'Receive-Soccerball/motions/1.npy', 'Receiver-Catch/motions/1.npy',
 'Soccer-Tackle/motions/1.npy', 'Swing-Dancing-3/motions/4.npy',
 'Throw-In/motions/1.npy',
 'Capoeira/motions/1.npy', 'Capoeira/motions/2.npy',
 'Death-From-The-Back/motions/1.npy', 'Ginga-Variation-3/motions/1.npy',
 'Jumping-Down/motions/1.npy', 'Martelo-Do-Chau/motions/1.npy',
 'Meia-Lua-De-Compasso-Back/motions/1.npy',
 'Meia-Lua-De-Frente/motions/1.npy', 'Punch-To-Elbow-Combo/motions/1.npy',
 'Punch-To-Elbow-Combo/motions/2.npy', 'Reload/motions/1.npy',
 'Reload/motions/2.npy', "Rockin'-Shackle-B/motions/1.npy",
 'Walking-To-Dying/motions/1.npy']
 '''
...
class MixamoDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        target112 = self.preprocessing(item1, view2, param1).detach()
        target121 = self.preprocessing(item12, view1, param2).detach()
        target122 = self.preprocessing(item12, view2, param2).detach()
        target221 = self.preprocessing(item2, view1, param2).detach()
        target212 = self.preprocessing(item21, view2, param1).detach()
